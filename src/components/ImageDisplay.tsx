...
export const ImageDisplay: React.FC<Props> = ({ imageUrl, prompt }) => {
  return (
    <div className="image-container mt-5 text-center flex justify-center">
      ...
      />
      <div className="image-overlay absolute top-0 left-0 right-0 bottom-0 bg-black bg-opacity-40 text-white flex items-center justify-center text-center rounded-lg">
